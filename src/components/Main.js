  ...
  return (
    <section aria-label="main" class="hero" id="main">
      <div class="hero-image">
        <img
          src="https://kenyihq.github.io/portfolio/img/kenyihq2x.png"
          alt="Profile picture"
          width="338"
          height="330"
        />
      ...
      <div class="hero-description">
        ...
        <p>
          Jr Developer y apasionado de la tecnología. Siempre buscando cosas
          nuevas por aprender. Soy el creador del blog{" "}
          <a
            class="link-blog"
            href="https://401u.blogspot.com/"
            target="_blank"
          >
            Error 401.
          </a>
        ...
        <a
          href="https://drive.google.com/file/d/1IiBuqSNPOEqFuTPvKtruReKUrozezMX8/view?usp=sharing"
          target="_blank"
          class="button"
        >
